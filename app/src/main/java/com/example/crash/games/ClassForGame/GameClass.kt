...
@SuppressLint("ClickableViewAccessibility")
 class GameClass(
    ...
    musorka: ImageView, blocks: ArrayList<Block> = arrayListOf<Block>(), blocksPool: PoolAbstract = Pool(parentPool, blocks, 0, displayheight / 2 - displayheight / 5, displaywidth),
) : AbstractPlayField(
    parentGame,
